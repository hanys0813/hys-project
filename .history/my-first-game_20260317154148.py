...
while True:
    ...
    #내가 요청 한 것
    #적한테 체력 게이지 바를 넣어주고 더 개선 해주라 
    # 그리고 장애물이 너무 밋밋해 네모만 있잖아 다양하게 만들어주고 
    # 더 간지나게 만들어주라 그리고 지금 적이 아마 내 공격 한방 맞으면 죽을거야 한방 맞으면 죽는 적이랑 좀 여러방 맞아야 
    # 죽는 적 이렇게 해서 만들어주라 밸런스 좋게